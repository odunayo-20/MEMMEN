                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <div class="form-floating">
                            <textarea wire:model.defer='content' class="form-control" placeholder="Leave a comment here" id="floatingTextarea"
                        ...
                        <div class="my-3">
                            <input wire:model.defer='new_image' type="file" class="form-control ">
                            @error('new_image')
                                <span class='text-danger'>{{ $message }}</span>
                            @enderror
                            @if ($old_image)
