        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="{{ route('index') }}">Terms & Condition</a>
                    <a class="btn btn-link" href="{{ route('index') }}">Support</a>
                </div>
                <div class="col-lg-3 col-md-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; {{ date('Y') }} <a class="fw-medium text-light" href="{{ route('admin_login') }}">MENo~MEN</a>, All Right Reserved.
                </div>
